...
void registerCardAndFingerprint() {
  ...
  exitPhotoMode();
  // for (int ii = 0; ii < 5; ii++)
    mySerial.println("RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
...
void normalScanFlow() {
  ...
  // for (int ii = 0; ii < 5; ii++)
    mySerial.println("OOOOOOOOOOOOOOOOOOOOOO");  // แจ้งว่า auth ผ่าน → UNO จะ canVote=true และเข้า PAGE_VOTE
